...
def box_plot(data_for_boxplot, label_for_boxplot, title_for_boxplot,
             path_for_boxplot):
...
def moment_rate(Run_name, plot_moment_rate, geologic_moment_rate_no_as,
                geologic_moment_rate, seismological_moment_rate,
                scenarios_names_list, total_list_scenario_name, MFD_type_list,
                total_list_MFD_type):
    '''#############################
    ###############################
    ...
    if plot_moment_rate == True:
        ...
        if not os.path.exists(
                str(Run_name) + '/analysis/figures/compare_moment_rate'):
            os.makedirs(str(Run_name) + '/analysis/figures/compare_moment_rate')

        path_for_boxplot = str(
            Run_name) + '/analysis/figures/compare_moment_rate/M0.png'
        title_for_boxplot = 'Compare M0'
        box_plot(data_for_boxplot, label_for_boxplot, title_for_boxplot,
                 path_for_boxplot)
    '''####################################
    ...
    if plot_moment_rate == True:
        ...
        for scenario_name in scenarios_names_list:
            ...
            M0_scenario_name = []
            rows = np.where(
                np.array(total_list_scenario_name) == scenario_name)[0]
        ...
        path_for_boxplot = str(
            Run_name
        ) + '/analysis/figures/compare_moment_rate/M0_each_model_sce_rup.png'
    ...
    if plot_moment_rate == True:
        ...
        path_for_boxplot = str(
            Run_name) + '/analysis/figures/compare_moment_rate/M0_each_mfd.png'
        title_for_boxplot = 'Compare M0 - each model \nof MFD'
        box_plot(data_for_boxplot, label_for_boxplot, title_for_boxplot,
                 path_for_boxplot)
